...
class _BodyDamageViewState extends State<BodyDamageView> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
        ...
        child: Scaffold(
            appBar: AppBar(
              title: const Text("الأضرار الجسدية"),
            ),
            body: SafeArea(
                          ...
                          children: [
                            ...
                            Container(
                                padding: EdgeInsets.only(
                                    right: 25, bottom: 10, top: 5),
                                alignment: Alignment.topRight,
                                child: Text("عدد الإصابات الخفيفة",
                                    style: TextStyle(color: Colors.blue),
                                    textAlign: TextAlign.end)),
                            GroupButton(
                              ...
                              controller: GroupButtonController(
                                  selectedIndex:
                                      appBodly.bodlyInsCountLightInj),
                            ...
                            Container(
                                padding: EdgeInsets.only(
                                    right: 25, bottom: 10, top: 5),
                                alignment: Alignment.topRight,
                                child: Text("عدد الإصابات الخطيرة",
                                    style: TextStyle(color: Colors.blue),
                                    textAlign: TextAlign.end)),
                            GroupButton(
                              controller: GroupButtonController(
                                  selectedIndex:
                                      appBodly.bodlyInsCountSeverInj),
                              options: GroupButtonOptions(
                                selectedShadow: const [],
                                selectedTextStyle: TextStyle(
                                  fontSize: 20,
                            ...
                            Container(
                                padding: EdgeInsets.only(
                                    right: 25, bottom: 10, top: 5),
                                alignment: Alignment.topRight,
                                child: Text("عدد الضحايا",
                                    style: TextStyle(color: Colors.blue),
                                    textAlign: TextAlign.end)),
                            GroupButton(
                              controller: GroupButtonController(
                                  selectedIndex: appBodly.bodlyInsCountDeath),
                              options: GroupButtonOptions(
                                selectedShadow: const [],
                                selectedTextStyle: TextStyle(
                                  fontSize: 20,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GroupButton(
                              controller: GroupButtonController(
                                  selectedIndex: appBodly.bodlyTpCountLightInj),
                              options: GroupButtonOptions(
                                selectedShadow: const [],
                                selectedTextStyle: TextStyle(
                                  fontSize: 20,
                            ...
                            GroupButton(
                              controller: GroupButtonController(
                                  selectedIndex: appBodly.bodlyTpCountSeverInj),
                            ...
                            GroupButton(
                              controller: GroupButtonController(
                                  selectedIndex: appBodly.bodlyTpCountDeath),
                              options: GroupButtonOptions(
                                selectedShadow: const [],
                                selectedTextStyle: TextStyle(
                                  fontSize: 20,
                          ...
                          child: Container(
                            child: ElevatedButton(
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                      flex: 1, child: Icon(Icons.arrow_back)),
                                  Expanded(
                                    flex: 4,
                                    child: Text(
                                      "العودة",
                          ...
                          child: Container(
                            child: ElevatedButton(
                              child: Row(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Expanded(flex: 1, child: Icon(Icons.wysiwyg)),
                                  Expanded(
                                    flex: 4,
                                    child: Text(
                                      "ملاحظات",
                              ...
                              onPressed: () async {
                                log("yyyyyyyyyyyyyyyyy" +
                                    appBodly.bodlyInsCountDeath.toString());
                                log("*************");
